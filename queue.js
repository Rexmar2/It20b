...
queue1.enqueue(4);
console.log("The size of queue is: "+ queue1.size());
queue1.enqueue(2);
console.log("The size of queue is: "+ queue1.size());
queue1.enqueue(3);
console.log("The size of queue is: "+ queue1.size());
...
console.log(queue1.dequeue()+" has been dequeue, the new front is: " + 3());
console.log(queue1.dequeue()+" has been dequeue, the new front is: " + 2());
